> [문서 안내](../README.md) › [검증 보고서](00-보고서-안내.md) › **1. 부하 테스트**
...
원본 실행 로그: [S1-a](증거/2026-09-06-s1-a.txt), [S1-b](증거/2026-09-06-s1-b.txt).

---

[← 보고서 안내](00-보고서-안내.md) · [목록](00-보고서-안내.md) · [2. 장애 주입 →](02-장애-주입.md)
